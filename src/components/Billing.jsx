...
const Billing = () => (
  <section
    id="product"
    className="py-6 sm:py-16 flex justify-center items-center flex-col-reverse md:flex-row"
  >
    ...
    <div className="flex flex-col flex-1 ">
      <h2 className={`${style.h2}`}>
        Easily control your{" "}
        <span className="whitespace-nowrap">billing & invoicing.</span>
      </h2>
      <p className={`${style.paragraph} mt-6 max-w-[470px]`}>
