...
const Testimonials = () => (
  <section id="clients" className="flex flex-col py-6 sm:py-16 relative">
    ...
    <div className="flex md:items-center w-full flex-col md:flex-row mb-6 sm:mb-15 relative z-[1]">
      <h1 className={`${style.h2} flex-1`}>What people are <br /> saying about us</h1>
      <div className="flex items-center flex-1 md:ml-10 mt-10 md:mt-0">
        <p className={`${style.paragraph} max-w-[470px]` }>Everything you need to accept card payments and grow your business anywhere on the planet.</p>
      </div>
    </div>
